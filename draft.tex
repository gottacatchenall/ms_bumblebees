...
``right'' as possible versus a model being useful for discovering
false-negatives.
...
times probability of cooccurrence via properties of conditional prob.
(Gravel \emph{et al.} 2019)
